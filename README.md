...
| **AutoML / Predictive Catch Models** | *The Engine Room* | Automated modeling pipelines for daily/weekly catch | 🔄 90% Complete | [View README](https://github.com/Euchie23/SquidStock/blob/main/notebooks/AutoML) | 🔄 In progress |
