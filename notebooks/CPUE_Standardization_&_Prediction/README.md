...
📄 **Figure:** `/results/plots/static/yearly_summary_JanJun.png`  
...
📊 `/results/plots/static/model_performance.png`  
📄 PDF: `/results/plots/static/model_performance.pdf`
...
| Visualization | File Path | Purpose |
|---------------|-----------|----------|
| **Observed vs Standardized CPUE** | `/results/plots/static/observed_vs_standardized.png` / `.html` | Compare raw and standardized indices |
| **Predicted vs Actual CPUE** | `/results/plots/static/predicted_vs_actual.png` | Assess predictive accuracy |
| **Residual Plots** | `/results/plots/static/residuals.png` | Check error distribution |
| **Model Performance Table** | `/results/plots/static/model_performance.png` | Summarize RMSE / MAE |
| **Yearly Summary (Jan–Jun)** | `/results/plots/static/yearly_summary_JanJun.png` | Context for environmental trends |

🕹️ Interactive versions (`.html`) are available in `/results/plots/interactive/`.
...
- `/results/plots/static/observed_vs_standardized.png`  
- `/results/plots/static/predicted_vs_actual.png`  
- `/results/plots/static/residuals.png`  
- `/results/plots/static/yearly_summary_JanJun.png`  

*(All outputs also available as interactive HTML files in `/results/plots/interactive/`.)*
